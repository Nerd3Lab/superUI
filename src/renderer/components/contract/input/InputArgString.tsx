...
const InputArgStringWrapper = styled.div``;

function InputArgString({ abi, onChangeInputValue, inputValue, index }: Props) {
  return (
    <InputArgStringWrapper>
